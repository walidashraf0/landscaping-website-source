...
import { Phone, Mail, MessageCircle, MapPin, Leaf, TreeDeciduous, Droplets, Hammer, Star, Menu, X, ChevronRight, Award, Users, Clock, Globe } from 'lucide-react'
import './App.css'
import landscapingIdea from './assets/images/landscaping_idea.jpg'
import smallGardenDesign from './assets/images/small_garden_design.jpg'
import summerLandscapeDesign from './assets/images/summer_landscape_design.jpg'
import lawnBeforeAfter from './assets/images/lawn_before_after.webp'
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-2xl font-bold text-gray-800">{t('common.brandName')}</span>
            </div>
            
            {/* Desktop Navigation */}
            <nav className="hidden md:flex items-center space-x-8">
              <a href="#home" className="text-gray-700 hover:text-green-600 transition-colors">{t('header.home')}</a>
              <a href="#services" className="text-gray-700 hover:text-green-600 transition-colors">{t('header.services')}</a>
              <a href="#portfolio" className="text-gray-700 hover:text-green-600 transition-colors">{t('header.portfolio')}</a>
              <a href="#about" className="text-gray-700 hover:text-green-600 transition-colors">{t('header.about')}</a>
              <a href="#contact" className="text-gray-700 hover:text-green-600 transition-colors">{t('header.contact')}</a>
            </nav>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {services.map((service, index) => (
              <Card key={index} className="hover:shadow-xl transition-shadow duration-300 border-0">
                <CardContent className="p-6">
                  ...
                  <Button variant="link" className="text-green-600 p-0 h-auto">
                    {t('services.learnMore')} <ChevronRight className={`w-4 h-4 ${isRTL ? 'rotate-180' : ''} ml-1`} />
                  </Button>
                </CardContent>
              </Card>
            ))}
      ...
      <section id="portfolio" className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-800 mb-4">{t('portfolio.title')}</h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            ...
            {portfolio.map((project, index) => (
              <div key={index} className="group relative overflow-hidden rounded-lg shadow-lg hover:shadow-2xl transition-all duration-300">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex flex-col justify-end p-6">
                  <span className="text-green-400 text-sm font-semibold mb-2">{project.category}</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
            ...
            <div className="space-y-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <a href="tel:+15551234567" className="text-gray-600 hover:text-green-600">{t('header.phone')}</a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <p className="font-semibold text-gray-800">{t('contact.info.whatsapp')}</p>
                      <a 
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:info@greenscape.com" className="text-gray-600 hover:text-green-600">info@greenscape.com</a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <p className="font-semibold text-gray-800">{t('contact.info.serviceArea')}</p>
                      <p className="text-gray-600">{t('contact.info.serviceAreaText')}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-green-50 p-6 rounded-lg">
                <h4 className="font-bold text-gray-800 mb-2">{t('contact.info.businessHours')}</h4>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                <Leaf className="w-8 h-8 text-green-600" />
                <span className="text-2xl font-bold">{t('common.brandName')}</span>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#home" className="text-gray-400 hover:text-green-600 transition-colors">{t('header.home')}</a></li>
                <li><a href="#services" className="text-gray-400 hover:text-green-600 transition-colors">{t('header.services')}</a></li>
                <li><a href="#portfolio" className="text-gray-400 hover:text-green-600 transition-colors">{t('header.portfolio')}</a></li>
                <li><a href="#about" className="text-gray-400 hover:text-green-600 transition-colors">{t('header.about')}</a></li>
              </ul>
            </div>
